package com.popstack.mvoter2015.rakhine.feature.candidate.detail
...
import com.popstack.mvoter2015.rakhine.databinding.ControllerCandidateDetailBinding
...
import com.popstack.mvoter2015.rakhine.feature.party.PartySharedElementTransitionChangeHandler
...
import com.popstack.mvoter2015.rakhine.helper.spannable.CenteredImageSpan


class CandidateDetailController(
  bundle: Bundle? = null
) : MvvmController<ControllerCandidateDetailBinding>(bundle) {
